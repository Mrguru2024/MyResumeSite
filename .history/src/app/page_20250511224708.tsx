      ...
      <div className="relative w-full min-h-screen bg-background-dark">
        ...
        <main className="relative z-10 snap-y snap-mandatory">
          ...
          >
            ...
            <form
              className="w-full max-w-lg bg-white/10 dark:bg-background-dark/60 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20 flex flex-col gap-6"
              onSubmit={(e) => {
