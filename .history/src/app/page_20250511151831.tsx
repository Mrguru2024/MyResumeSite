...
export default function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen bg-background-dark">
      ...
      {/* BlueprintRoute container - positioned relative to hero */}
      <div className="fixed right-0 top-1/2 -translate-y-1/2 w-[560px] h-[calc(100vh-2rem)] z-40 pointer-events-none">
        <ErrorBoundary FallbackComponent={ErrorFallback}>
          <BlueprintRoute />
        </ErrorBoundary>
      </div>
