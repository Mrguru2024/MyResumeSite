      ...
      <div className="relative w-full min-h-screen bg-background-dark">
        ...
        <main className="relative z-10 snap-y snap-mandatory">
          ...
          >
            ...
            <div className="w-full max-w-lg bg-white/10 dark:bg-background-dark/60 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-white/20 flex flex-col gap-6 mb-8">
            ...
            {/* Email Me Button */}
            <a
              href="mailto:anthony.feaster@email.com"
              className="inline-block px-8 py-4 rounded-full bg-emerald-500 text-white font-bold text-lg shadow-lg hover:bg-emerald-600 transition-colors focus:outline-none focus:ring-4 focus:ring-emerald-400"
              aria-label="Email Anthony Feaster"
            >
              Email Me
            </a>
          </section>
