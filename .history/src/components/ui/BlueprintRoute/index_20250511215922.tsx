...
export default function BlueprintRoute() {
  ...
  // Dynamically set SVG height to cover all markers
  const svgHeight = markerPoints.length
    ? Math.max(window.innerHeight, markerPoints[markerPoints.length - 1].y + 200)
    : window.innerHeight;
