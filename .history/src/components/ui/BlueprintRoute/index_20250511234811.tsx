...
function SoundToggle({
  ...
  return (
    <button
      onClick={onToggle}
      className="fixed bottom-4 right-4 z-50 bg-card-bg border border-card-border rounded-full p-2 shadow-lg hover:scale-110 transition-transform pointer-events-auto"
          ...
          if (i === 0) {
            ...
            return (
              <motion.circle
                ...
                style={{ filter: "drop-shadow(0 0 10px #38bdf8)", opacity: 1 }}
                onMouseEnter={() => {
                  play("markerHover");
                  setTooltip({
                    show: true,
