          ...
          {lastMarkerPosition && lastSection && (
            ...
            >
              ...
              <rect
                ...
                strokeWidth={2}
              />
              <rect x={lastMarkerPosition.x - 4} y={lastMarkerPosition.y - 4} width={3} height={8} rx={1} fill="#fbbf24" />
              <rect x={lastMarkerPosition.x + 1} y={lastMarkerPosition.y - 4} width={3} height={8} rx={1} fill="#fbbf24" />
              <motion.polygon
                points={`
