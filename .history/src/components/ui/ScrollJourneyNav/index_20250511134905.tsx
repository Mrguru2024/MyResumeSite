...
export default function ScrollJourneyNav() {
  ...
  return (
    <div className="fixed left-6 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center h-4/5 select-none pointer-events-none">
      <svg height="100%" width="32" viewBox="0 0 32 100%" className="absolute left-1/2 -translate-x-1/2 h-full" style={{ minHeight: 400 }}>
        <line x1="16" y1="0" x2="16" y2="100%" stroke="#3b82f6" strokeWidth="4" strokeDasharray="8 8" />
      </svg>
      <div className="relative flex flex-col justify-between h-full w-8">
        {SECTIONS.map((section, i) => (
          <motion.div
            ...
            animate={active === i ? { scale: 1.3, boxShadow: "0 0 0 6px #3b82f680" } : { scale: 1, boxShadow: "none" }}
