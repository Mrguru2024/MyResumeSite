...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      const primaryHue = primaryColor.split(' ')[0];
      const primarySaturation = primaryColor.split(' ')[1];
      const primaryLightness = primaryColor.split(' ')[2];
      ...
      dots.forEach(dot => {
        ...
        gradient.addColorStop(0, `hsla(${primaryHue}, ${primarySaturation}, ${primaryLightness}, 0.8)`);
        gradient.addColorStop(1, `hsla(${primaryHue}, ${primarySaturation}, ${primaryLightness}, 0.1)`);
        
        ctx.fillStyle = gradient;
        ctx.shadowColor = `hsla(${primaryHue}, ${primarySaturation}, ${primaryLightness}, 0.5)`;
        ctx.shadowBlur = 12;
        ctx.fill();
        ctx.shadowBlur = 0;
      });
