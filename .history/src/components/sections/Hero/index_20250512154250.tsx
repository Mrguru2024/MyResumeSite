...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      gradient.addColorStop(0, `hsla(${adjustedHue}, ${adjustedSaturation}%, ${adjustedLightness}%, 0.08)`);
      gradient.addColorStop(1, `hsla(${adjustedHue}, ${adjustedSaturation}%, ${adjustedLightness}%, 0.03)`);
