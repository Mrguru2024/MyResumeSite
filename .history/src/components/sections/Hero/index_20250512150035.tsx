...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      const adjustedHue = isDarkMode ? (hue + 180) % 360 : hue; // Complementary color in dark mode
      ...
      dots.forEach(dot => {
        ...
        if (isDarkMode) {
          gradient.addColorStop(0, `hsla(${adjustedHue}, ${adjustedSaturation}%, 100%, ${baseOpacity})`);
          gradient.addColorStop(0.5, `hsla(${adjustedHue}, ${adjustedSaturation}%, ${adjustedLightness}%, ${baseOpacity * 0.8})`);
          gradient.addColorStop(1, `hsla(${adjustedHue}, ${adjustedSaturation}%, ${adjustedLightness}%, ${fadeOpacity})`);
        } else {
          gradient.addColorStop(0, `hsla(${hue}, ${saturation}%, ${lightness}%, ${baseOpacity})`);
          gradient.addColorStop(1, `hsla(${hue}, ${saturation}%, ${lightness}%, ${fadeOpacity})`);
        }
