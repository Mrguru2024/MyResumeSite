      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-2xl sm:text-3xl md:text-4xl font-mono font-semibold text-sky-400 drop-shadow-lg mb-12 min-h-[2.5rem] flex items-center justify-center gap-2"
            aria-label={TYPING_TEXT}
            style={{ letterSpacing: "0.01em" }}
          >
            <span className="[text-shadow:_0_2px_16px_#38bdf8]">
              {typedSubtitle}
            </span>
            <span
              className={
                typingDone
                  ? "ml-1 w-3 h-8 bg-sky-400 rounded animate-blink"
                  : "ml-1 w-3 h-8 bg-sky-400 rounded animate-pulse"
              }
              style={{
