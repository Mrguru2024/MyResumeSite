...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      const adjustedLightness = isDarkMode ? Math.min(lightness + 30, 100) : lightness;
      ...
      dots.forEach(dot => {
        ...
        const gradient = ctx.createRadialGradient(dot.x, y, 0, dot.x, y, dot.r * 2.5);

        // Use theme colors with varying opacity
        const baseOpacity = isDarkMode ? 1 : 0.9;
        const fadeOpacity = isDarkMode ? 0.3 : 0.2;
        ...
        ctx.shadowColor = `hsla(${hue}, ${saturation}%, ${adjustedLightness}%, ${isDarkMode ? 0.8 : 0.6})`;
