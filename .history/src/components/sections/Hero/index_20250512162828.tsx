...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen w-screen flex items-center justify-center relative pt-32 overflow-hidden bg-transparent">
      <HeroGlassParticles />
      {/* Enhanced gradient overlay for smooth bottom transition in both themes */}
      <div className="absolute bottom-0 left-0 w-full h-40 pointer-events-none z-10 bg-gradient-to-b from-transparent to-slate-100/90 dark:to-background" />
