      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-transparent">
        ...
        >
          ...
          <div className="relative perspective-1000 flex flex-col items-center justify-center">
            {/* Badge above card, not overlapping */}
            <motion.div
              className="mb-4 px-4 py-1 rounded-full bg-emerald-500/90 text-white font-semibold text-sm shadow-md border border-white/20 backdrop-blur-md max-w-xs text-center whitespace-pre-line"
