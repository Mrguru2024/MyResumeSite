            ...
            >
              ...
              >
                ...
                <motion.button
                  ...
                  className={cn(
                    "w-full rounded-2xl p-4 sm:p-6 md:p-10 shadow-2xl flex flex-col items-center justify-center border-2 border-transparent bg-white/30 dark:bg-background-dark/60 backdrop-blur-xl z-10 select-none transition-transform duration-300 absolute inset-0",
                ...
                <motion.button
                  ...
                  aria-pressed={!isFlipped}
                  className={cn(
                    "w-full rounded-2xl p-4 sm:p-6 md:p-10 shadow-2xl flex flex-col justify-center border-2 border-transparent bg-background-dark/90 dark:bg-white/90 backdrop-blur-xl z-10 select-none transition-transform duration-300 absolute inset-0",
                    !isFlipped && "pointer-events-none",
                  )}
                  style={{
                    boxShadow: "0 8px 40px 0 #10b98122, 0 1.5px 8px #0002",
