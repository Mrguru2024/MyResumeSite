...
export default function About() {
  ...
  }, [isActive, autoFlipped, isFlipped]);
  ...
  return (
    <section
      className="min-h-screen flex flex-col items-center justify-center relative pt-32 overflow-hidden"
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-transparent">
        ...
        >
          ...
          <div className="flex w-full justify-center items-center mt-4 sm:mt-8">
            <motion.button
              ref={cardRef}
              type="button"
              ...
              animate={{
                minHeight: isFlipped ? "36rem" : "26rem",
                minWidth: isFlipped ? "26rem" : "20rem",
                maxWidth: isFlipped ? "48rem" : "32rem",
                boxShadow: isFlipped
                  ? "0 12px 48px 0 #10b98144, 0 2px 12px #0003"
                  : "0 8px 40px 0 #10b98122, 0 1.5px 8px #0002",
              }}
            ...
            >
              ...
              {/* Flipping Content (Summary/Details) */}
