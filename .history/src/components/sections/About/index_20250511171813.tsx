          ...
          <div className="flex justify-center items-center mt-4 sm:mt-8">
            ...
            >
              ...
              >
                ...
                <motion.div
                  className={cn(
                    "absolute w-full rounded-2xl p-4 sm:p-6 md:p-10 shadow-2xl flex flex-col items-center justify-center border-2 border-transparent bg-white/30 dark:bg-background-dark/60 backdrop-blur-xl z-10",
                ...
                >
                  ...
                  <motion.span
                    className="mt-2 text-xs sm:text-sm md:text-base text-emerald-500 font-mono tracking-wide"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                <motion.div
                  className={cn(
                    "absolute w-full rounded-2xl p-4 sm:p-6 md:p-10 shadow-2xl flex flex-col justify-center border-2 border-transparent bg-background-dark/90 dark:bg-white/90 backdrop-blur-xl rotate-y-180 z-10",
                    !isFlipped && "pointer-events-none opacity-0"
                  )}
                  style={{
                    boxShadow: "0 8px 40px 0 #10b98122, 0 1.5px 8px #0002",
                ...
                >
                  ...
                  <motion.span
                    className="mt-4 text-xs sm:text-sm md:text-base text-emerald-500 font-mono tracking-wide text-center"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
