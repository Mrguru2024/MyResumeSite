    ...
    <section className="min-h-screen flex items-center justify-center relative pt-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-transparent">
        ...
        >
          ...
          <div className="relative perspective-1000 flex justify-center items-center">
            ...
            <motion.button
              ref={cardRef}
              className="relative w-full h-[380px] md:h-[420px] xl:h-[480px] flex items-center justify-center focus:outline-none bg-transparent border-0 cursor-pointer z-10"
              style={{
                perspective: 1000,
                transform: `rotateY(${isFlipped ? 180 : 0}deg) rotateX(${-tilt.y * 10}deg) rotateY(${tilt.x * 10}deg)`,
            ...
            >
              ...
              >
                {/* Floating badge */}
                <motion.div
                  className="absolute -top-7 left-1/2 -translate-x-1/2 px-5 py-2 rounded-full bg-emerald-500/90 text-white font-bold text-base shadow-lg border-2 border-white/30 backdrop-blur-md"
