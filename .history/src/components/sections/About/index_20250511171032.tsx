  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative pt-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-transparent">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-extrabold text-text-primary mb-6 text-center tracking-tight drop-shadow-lg">
            About Me
          </h2>
          {/* Badge above card, always readable, never flips */}
          <motion.div
            className="mb-6 px-5 py-2 rounded-full bg-emerald-500/90 text-white font-semibold text-base shadow-md border border-white/20 backdrop-blur-md max-w-xs text-center whitespace-pre-line"
