          ...
          <div className="flex justify-center items-center mt-4 sm:mt-8">
            ...
            >
              ...
              >
                ...
                <motion.div
                  className={cn(
                    "absolute w-full h-full rounded-2xl p-6 sm:p-10 md:p-14 shadow-2xl flex flex-col items-center justify-center border-2 border-transparent bg-white/30 dark:bg-background-dark/60 backdrop-blur-xl z-10",
                ...
                >
                  ...
                  <motion.div
                    className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-700 border-4 border-white shadow-lg mb-4 sm:mb-6 flex items-center justify-center overflow-hidden"
                  ...
                  {/* Divider */}
                  <motion.div
                    className="w-20 sm:w-24 h-1 rounded-full bg-gradient-to-r from-emerald-400 via-emerald-300 to-emerald-500 mb-4 sm:mb-6"
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: 1 }}
                    transition={{ delay: 0.35, duration: 0.5 }}
                  />
                  <motion.h3
                    className="text-xl sm:text-2xl font-extrabold text-text-primary text-center mb-2 drop-shadow"
                  ...
                  <motion.p
                    className="text-base sm:text-lg text-text-secondary text-center mb-2"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <motion.span
                    className="mt-2 text-xs sm:text-base text-emerald-500 font-mono tracking-wide"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                <motion.div
                  className={cn(
                    "absolute w-full h-full rounded-2xl p-6 sm:p-10 md:p-14 shadow-2xl flex flex-col justify-center border-2 border-transparent bg-background-dark/90 dark:bg-white/90 backdrop-blur-xl rotate-y-180",
                    !isFlipped && "pointer-events-none opacity-0",
                  )}
                  style={{
                    boxShadow: "0 8px 40px 0 #10b98122, 0 1.5px 8px #0002",
                ...
                >
                  <motion.h3
                    className="text-xl sm:text-2xl font-extrabold text-text-primary mb-4 text-center drop-shadow"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <motion.p
                    className="text-base sm:text-lg text-text-secondary mb-4 text-center"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.2, duration: 0.5 }}
                  >
                  ...
                  <motion.span
                    className="mt-4 text-xs sm:text-base text-emerald-500 font-mono tracking-wide text-center"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
              ...
              {/* Clickable area for flipping only covers the card */}
              <button
